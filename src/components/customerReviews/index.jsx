...
//                             <button onClick={() => setShowModal(false)} className="cursor-pointer hover:scale-[1.2] transition-all duration-[0.3s] ease-in-out">
...
//                                         <input className='w-full py-[10px] px-[15px] border-[#e5e5e5] border-[1px] rounded-[3px]' type="email" placeholder='Email' />
//                                     </div>
//                                     <div className="flex gap-2">
//                                         <div className="w-[50%]">
//                                             <input className='w-full py-[10px] px-[15px] border-[#e5e5e5] border-[1px] rounded-[3px]' type="text" placeholder='First Name' />
//                                         </div>
//                                         <div className="w-[50%]">
//                                             <input className='w-full py-[10px] px-[15px] border-[#e5e5e5] border-[1px] rounded-[3px]' type="text" placeholder='Last Name' />
//                                         </div>
//                                     </div>
...
//                                     </div>
//                                     <div className="">
//                                         <textarea placeholder='Write a comment' className='w-full h-[100px] py-[10px] px-[15px] border-[#e5e5e5] border-[1px] rounded-[3px]' name="comment" id="comment"></textarea>
//                                     </div>
