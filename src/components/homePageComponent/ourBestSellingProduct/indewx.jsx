...
const OurBestSellingProduct = () => {
    const [thumbsSwiper, setThumbsSwiper] = useState(null);

    return (
        <div className="max-w-[1125px] mx-auto px-4 xl:px-0 py-[30px]">
            <h2 className="text-[#000000] text-[22px] md:text-[26px] text-center mb-12">
                Our best selling products
            </h2>
            <h3 className="text-[#000000] text-[25px] font-[500] block lg:hidden">bee nectar gel</h3>
