...
import Loader from '../../../themes/theme1/components/loader/index';
    ...
    return (
        <div className='success-main container mx-auto px-4 lg:px-100 py-12 pt-16 md:pt-20 pb-12'>
            <div className="flex flex-col justify-center text-center items-center">
                ...
                <Link href="/pl3" className='w-fit mx-auto cursor-pointer hover:scale-[1.05] transition-all duration-[0.3s] ease-in-out py-3 text-md md:text-lg px-6 rounded-lg bg-black text-white font-[500] mt-6'>{t('Continue_Shopping')}</Link>
            </div>
        </div>
    );
};
