...
const reviews = [
    {
        ...
        review: {
            en: 'Absolutely love this product! It changed my skincare routine forever.',
            ar: 'أحببت هذا المنتج كثيرًا! غيّر روتين العناية بالبشرة لدي تمامًا.',
        },
        rating: 5,
    },
    {
        ...
        review: {
            en: 'Great value for money and fast shipping. Highly recommend!',
            ar: 'قيمة ممتازة مقابل السعر وشحن سريع. أوصي به بشدة!',
        },
        rating: 4,
    },
    {
        ...
        review: {
            en: 'Impressed by the quality. Will definitely order again.',
            ar: 'مبهورة بالجودة. بالتأكيد سأطلب مرة أخرى.',
        },
        rating: 5,
    },
    {
    ...
    },
    {
        ...
        review: {
            en: 'Impressed by the quality. Will definitely order again. Impressed by the quality. Will definitely order again. Impressed by the quality. Will definitely order again.',
            ar: 'مبهورة بالجودة. بالتأكيد سأطلب مرة أخرى. مبهورة بالجودة. بالتأكيد سأطلب مرة أخرى. مبهورة بالجودة. بالتأكيد سأطلب مرة أخرى.',
        },
        rating: 5,
    },
];
...
const Customerreviews = () => {
    ...
    const validateForm = () => {
        ...
        if (!formData.firstName) {
            newErrors.firstName = t('First_name_is_required');
            isValid = false;
        }

        if (selectedRating === 0) {
            newErrors.rating = t('Please_select_a_rating');
            isValid = false;
        }

        if (!formData.comment) {
            newErrors.comment = t('Comment_is_required');
            isValid = false;
        }
            ...
            <div className='reviews-main'>
                <div className="max-w-[1125px] mx-auto px-4 xl:px-0 py-[30px]">
                    ...
                    <h2 className={`text-[#000000] text-[22px] md:text-[24px] text-center ${language === "ar" ? "font-[600]" : "font-[500]"}`}>
                        ...
                        <p className='text-[#696969] text-[14px] text-center'>{t('Add_your_rating')}</p>
                    </div>

                    <div className="adding-rating flex flex-col md:flex-row items-center justify-between" >
                        <h3 className='font-[500] text-[18px]'>{t('Customer_review')}</h3>
                    ...
                    <div className="reviews-slider mt-8 " dir={currentLang === 'ar' ? 'rtl' : 'ltr'}>
                        <Swiper
                            ...
                            {reviews.map((review, index) => (
                                <SwiperSlide key={index}>
                                    <div className="single-review rounded-[3px] border-[#f0f0f0] border-[1px] p-6 text-center">
                                        <p className="text-gray-800 text-lg mb-4 italic line-clamp-2 h-[60px]">
                                        ...
                                        <p className="text-gray-600 font-medium mb-4">– {review.name[currentLang]}</p>
                                    </div>
                                </SwiperSlide>
                            ))}
                        </Swiper>
                ...
                <div className="fixed overflow-y-auto py-20 inset-0 z-50 flex items-center justify-center bg-[#000000d9] bg-opacity-60">
                    <div className="bg-white rounded-lg shadow-xl w-[90%] max-w-lg">
                        <div className="flex justify-between items-center px-6 py-4 border-b-[#f0f0f0] border-b-[1px]">
                            <h3 className="text-xl font-[600]">{t('Add_your_rating')}</h3>
                                    ...
                                    <div className="my-4 relative border-[1px] border-dashed border-[#f0f0f0] min-h-[100px] flex justify-center items-center">
                                        ...
                                        {selectedImages.length > 0 ? (
                                            ...
                                            <div className="flex flex-col items-center justify-center absolute">
                                                ...
                                                <p>{t('Drag_the_file_or_click_to_upload')}</p>
                                            </div>
                                        )}
                                    </div>
